...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<p class="text-center">Login with details</p>   
	<form action="#" class="custom-form" method="post" id="get_login" ajax_url="<?php echo admin_url('admin-ajax.php');?>">
    ...
    <div class="text-center" id="login_error" style="color:red" >   </div>   
    <p class="text-center">Have no account? <a href="<?php echo home_url('registration-page');?>">Registration</a> </p>                                                                 
</form>
</article>
</div> <!-- card.// -->
