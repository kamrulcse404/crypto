...
.card-summary__left--value[_ngcontent-iuh-c80] {
    font-size: 60px;
    font-weight: 600;
  }
  @media only screen and (min-width: 992px) and (max-width: 1200px) {
        .card-summary__PaymentSatisfied[_ngcontent-iuh-c80] {
          min-width: 120px;
        }
        .card-summary__left--value[_ngcontent-iuh-c80] {
          font-size: 45px;
        ...
        .card-summary-long-string[_ngcontent-iuh-c80] {
          font-size: 25px !important;
          line-height: 86px;
        }
      }
      ...
      .card-summary__right--bounded[_ngcontent-iuh-c80] {
        display: flex;
        justify-content: center;
        align-items: center;
        font-size: 16px;
...
.card-summary[_ngcontent-iuh-c80] {
  display: flex;
  justify-content: space-around;
  margin-top: 16px;
  margin-bottom: 16px;
...
.card-content[_ngcontent-iuh-c80] {
	display: flex;
	flex-wrap: wrap;
}

.card-content__item[_ngcontent-iuh-c80]:first-child {
	border-left: unset;
	border-right: unset;
}
</style>